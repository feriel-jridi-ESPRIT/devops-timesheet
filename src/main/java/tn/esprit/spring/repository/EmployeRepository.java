...
public interface EmployeRepository extends CrudRepository<Employe, Integer>  {
	...
	@Query("SELECT e FROM Employe e WHERE e.email=:email and e.pwd=:pwd")
	public Employe getEmployeByEmailAndPassword(@Param("email")String login, @Param("pwd")String password);
