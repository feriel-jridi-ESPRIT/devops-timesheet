...
public class Employe implements Serializable {
	...
	public Employe(int id, String prenom, String nom, String email, String pwd, boolean actif, Role role) {
		super();
		this.id = id;
		this.prenom = prenom;
		this.nom = nom;
	...
	public Employe(String nom, String prenom, String email, String pwd, boolean actif, Role role) {
		this.nom = nom;
		this.prenom = prenom;
		this.email = email;
		this.pwd = pwd;
