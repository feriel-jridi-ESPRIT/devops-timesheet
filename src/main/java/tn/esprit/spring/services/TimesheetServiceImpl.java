...
public class TimesheetServiceImpl implements ITimesheetService {
	...
	public void validerTimesheet(int missionId, int employeId, Date dateDebut, Date dateFin, int validateurId) {
		...
		Optional<Employe> validateurRepo = employeRepository.findById(validateurId);
		Optional<Mission> missionRepo = missionRepository.findById(missionId);
		Mission mission = new Mission();
		Employe validateur = new Employe();
		if( validateurRepo.isPresent() &&missionRepo.isPresent() ){
			validateur = validateurRepo.get();
			mission =missionRepo.get();
		}
