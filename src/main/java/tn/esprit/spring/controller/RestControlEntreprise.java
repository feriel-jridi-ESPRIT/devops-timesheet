...
import tn.esprit.spring.request.DepartementRequestModel;
import tn.esprit.spring.request.EntrepriseRequestModel;
...
public class RestControlEntreprise {
	...
	@ResponseBody
	public int ajouterEntreprise(@RequestBody EntrepriseRequestModel ssiiConsulting) {

		ientrepriseservice.ajouterEntreprise(ssiiConsulting.convert());
	...
	public int ajouterDepartement(@RequestBody DepartementRequestModel dep) {
		return ientrepriseservice.ajouterDepartement(dep.convert());
	}
